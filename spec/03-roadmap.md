...
- [ ] **5.5-02 セラー写真処理の安定化**: 起票済み [Issue #48](https://github.com/akihotsuji/alco-app/issues/48) を追跡Issueとして、現行コードで成立する仮説を再確認し、P0/P1を1関心事の子Issueへ分割して順に解決する。WebGPU・WASMマルチスレッド・モデル交換は実測後に別Issueで判断する（2026-09-07: P0/P1 実装済み。実機再確認と P2/P3 の確定が残り）
