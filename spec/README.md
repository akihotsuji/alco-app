...
| [features/bottle-tasting.md](features/bottle-tasting.md) | 味わい中（開栓したボトルを数日かけて記録。セラー上部・ホームの立ちボトル、飲み切り、貯蔵庫の意味の変更） | 承認済み・実装済み（2026-09-24。#190） |
...
| [legal.md](legal.md) | 利用規約・PP の草案とデータマップ | 8-01（2026-09-21。承認待ち。友達・近況を反映） |
...
| [features/feedback.md](features/feedback.md) | 設定からのご意見・ご要望（画像・退会時匿名化・Resend 通知） | 2026-09-12 |
