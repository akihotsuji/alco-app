...
| [wireframes.md](wireframes.md) | 主要画面の配置・優先順位・最短タップ（Win98 essences のメタファー） | 作成済み（1-02） |
| [design-system.md](design-system.md) | 配色・タイポグラフィ・コンポーネント方針（Win98 essences、OS追従） | 作成済み（1-03） |
