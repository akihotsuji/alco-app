...
| セラーの見せ方 | 棚（陳列）。開栓で **味わい中**（セラー上部の丸アイコン列）、「飲み切った」で貯蔵庫（`/cellar/archive`）へ | 2026-09-05 オーナー指示（1-07）。2026-09-06 に開栓＝貯蔵庫へ。2026-09-24 に開栓＝味わい中へ見直し（[bottle-tasting.md](features/bottle-tasting.md)） |
...
| ID | 画面 | パス | 親タブ | タブバー | 備考 |
|---|---|---|---|---|---|
| bottle-list | セラー（棚） | `/cellar` | cellar | 表示 | 在庫（`sealed`）を棚 / 管理一覧で表示。上部に味わい中の丸アイコン列（補助表示）。種類・検索はクエリ。棚の見出しから `bottle-type-grid` |
