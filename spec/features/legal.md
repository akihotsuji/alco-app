...
- 状態: **草案**（2026-09-21。友達・近況共有を文面へ反映。共有セラー・退会・ご意見・AI 照合・PWA も含む。再同意ゲートは作らない）。法的効力の確定と事業者表示（氏名・住所・連絡先）はオーナー承認。エージェントは構成・実装フック・個人情報の棚卸しまで
...
- 更新時の再同意ゲート（重大変更時は将来。8-01 は初回サインアップのみ。2026-09-21 の友達反映でもゲートは作らない）
- 権利侵害の報告ボタン（申出は連絡先プレースホルダ。legal.md 1.1）
- 英語版
...
| 再同意 | 作らない。版と施行日を公開ページに出す。2026-09-13 の共有セラー反映、2026-09-21 の友達反映でも既存ユーザーはロックしない。友達は重大変更になり得るが、再同意するかはオーナーが後で決める | 要確認のまま実装しない |
...
- [legal.md](../legal.md) — データマップと草案（版 `2026-09-21`）
- [auth.md](auth.md)
