...
| N3b | 識別 | ヴィンテージ / 品種 / 生産者 / 生産国 | 空 | **常時表示**。任意。ヴィンテージは 1800〜2100 / 空 = 未登録（保存は null。表示で NV と書かない）。生産国は実在国の日本語名から選ぶ。他は ≦100。ボトル選択時は空欄ならボトルから。AI は空欄、または直前の AI 値を再読取で上書き。根拠不足は空欄 |
