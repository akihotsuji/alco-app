...
規約・PP に共有範囲（在庫・写真・メモは参加者に見える。飲酒記録・ノートは **共有セラーでは出さない**。友達近況の投影は別で [legal.md](../legal.md) / [friends-social.md](friends-social.md)）、招待リンク、脱退後の残存、未ログイン `/join` の非開示を書く。再同意ゲートは作らない（8-01 どおり）。
