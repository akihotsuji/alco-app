...
| T5 | プロパティ | 順: 品名 / 種類 / ヴィンテージ（無ければ「NV」）/ 品種 / 生産国 / 生産者 / 購入日 / 価格 / 購入場所 / 保管日 / 保管場所 / メモ。品名・種類・ヴィンテージ以外は空行を出さない。価格は `¥3,800`（整数・桁区切り） | data-model 6.3 |
...
- T3 は **「ノートを書く」**（Button 主）に置き換える。`/notes/new?bottleId=`（撮影しない。**4-03 で出す**。ノート本体は Phase 5）
- T4 を出す
