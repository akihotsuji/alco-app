...
| 03 | [マイドリンク](03-my-drinks.md) | プリセット登録と 1 タップ記録（**ホームのみ**）、ホームのキャラクター。1 タップの演出（M-07〜M-09 / M-17 / M-18）。**ホームの導線と中央タブの切替**: 中央タブ / カメラ円ボタン = 撮影開始 → 写真付き `log-new`（着地・現在地ハイライトなし）、今日カード → 今日の日別、「今週 ›」→ 週、週マス → 日別（X6） |
