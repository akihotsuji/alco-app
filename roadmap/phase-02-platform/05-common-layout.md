...
- [ ] 未ログインでタブ配下が開けない
- [ ] タブ遷移ができる。中央タブが `/logs` に着地し、現在地で inset になる
- [ ] loading/error の出し方がある
- [ ] モバイル幅で横スクロールしない。320px でラベルが折り返さない
- [ ] [spec/screen-designs/00-common.md](../../spec/screen-designs/00-common.md) の受け入れチェック全項目
- [ ] lint / typecheck
