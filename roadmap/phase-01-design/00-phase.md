...
|---|---|
| 目安 | 3〜5日 |
| 状態 | **完了**（1-01〜1-06 は 2026-09-04、1-07 / 1-08 / 1-09（[spec/motion-design.md](../../spec/motion-design.md)）は 2026-09-06 承認。中央タブの着地のみ回答待ちで既定 (a)） |
...
- 1-07 の要確認は **中央タブの着地**のみ残る（2026-09-06 に本数上限 12・ノート写真 6・キャラは名前なしで確定）。既定 (a) は [spec/screen-designs/README.md](../../spec/screen-designs/README.md)
- SE 幅の折り返しは 2-05
