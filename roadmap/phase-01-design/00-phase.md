...
|---|---|
| 目安 | 3〜5日 |
| 状態 | **完了**（1-01〜1-06 は 2026-09-04、1-07 / 1-08 / 1-09（[spec/motion-design.md](../../spec/motion-design.md)）は 2026-09-06 承認。中央タブの挙動は同日 (c) 撮影開始で確定） |
...
- 1-07 の要確認はすべて確定（2026-09-06 に本数上限 12・ノート写真 6・キャラは名前なし、中央タブの挙動は **(c) 撮影開始**）。詳細は [spec/screen-designs/README.md](../../spec/screen-designs/README.md)
- SE 幅の折り返しは 2-05
