...
|---|---|
| フェーズ | Phase 1 設計 |
| ステータス | **完了**（2026-09-06 オーナー承認。名前は付けない。成果物: [spec/character.md](../../spec/character.md)、[spec/assets/character/](../../spec/assets/character/)） |
...
- 名前（2026-09-06 に「付けない」で確定。UI に出さない）
...
- [x] 配置・合成・禁止が数値で書いてある
- [x] 飲酒を促す文言に添えないと明記
- [x] オーナー承認（モチーフ・ポーズ数。名前は付けない。2026-09-06）
