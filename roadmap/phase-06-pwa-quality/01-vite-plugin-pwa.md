...
- [x] manifest がビルドに含まれる
- [x] standalone 指定
- [x] アイコンがある
- [x] SW が API を無理にキャッシュして古いデータを出さない
- [x] lint / typecheck
- [x] 監査（SW が秘密をキャッシュしない）

表示名の仮決め: `name=alco-app` / `short_name=alco`（正本は [spec/features/pwa.md](../../spec/features/pwa.md)）。
