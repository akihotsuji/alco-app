...
| 判定 | 内容 |
|---|---|
| **完了** | 0-01〜0-06、0-09。GitHub プライベート、`.gitignore`、Hello World、TypeScript strict / Biome、Vitest、Cloudflare dev D1/R2、rules/skills |
| **未着手** | 0-07 CI（`.github/` なし）、0-08 ブランチ保護、Phase 1 以降の設計3点セット |
