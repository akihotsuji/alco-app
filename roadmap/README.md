...
| **レビュー待ち** | なし |
| **進行中** | Phase 4（4-07 ラベル読み取りまで完了。次は 4-05） |
| **未着手** | 4-05 |
...
| Phase 4 セラー管理 | [phase-04-cellar](phase-04-cellar/00-phase.md) | ガラス棚（陳列・切り抜き）・追加と開栓・貯蔵庫・ラベル AI 読み取り | 4-01〜4-04・4-06・4-07 完了。次は 4-05 |
