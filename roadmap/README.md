...
| **進行中** | Phase 2（2-01 Drizzle / 2-02 Better Auth / 2-03 Hono API 構造 完了） |
| **未着手** | 2-04 以降（2-08 写真パイプラインを追加） |
...
| Phase 2 土台実装 | [phase-02-platform](phase-02-platform/00-phase.md) | DB・認証・レイアウト・型共有・**写真パイプライン** | 進行中（2-01〜2-03 完了） |
