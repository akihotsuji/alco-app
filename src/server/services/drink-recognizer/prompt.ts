...
export const DRINK_RECOGNIZE_SYSTEM_PROMPT = [
  ...
  "wine_red=赤ワイン/red wine/ruby/garnet/dark glass,",
  "wine_white=白ワイン/white wine/straw/gold/pale/clear glass,",
  "wine_rose=ロゼ/rosé/pink,",
  "wine_sparkling=スパークリング/champagne/cava/prosecco/bubbles/foil cage,",
  "wine_orange=オレンジワイン/amber/skin-contact/orange wine.",
