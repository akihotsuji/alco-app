  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "メールアドレスとパスワードで登録します。招待コードはありません。パスワードを忘れた場合は、登録メール宛に再設定用の案内を送れます。認証情報は第三者に貸与・共有しないでください。セッションはCookieで維持します。詳細はプライバシーポリシーを見てください。",
        },
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "取得する情報は、アカウント（メール、パスワードのハッシュ、任意の表示名）、セッション、規約への同意、年齢確認（生年月日は確認に成功したときだけ）、パスワード再設定の短命トークン、飲酒記録、マイドリンク、セラー、ノート、加工後の写真、AI利用回数、任意の位置情報（店名と座標）、バックアップ、運用ログです。端末だけの設定（外観、触感、動き、写真の既定、認識のON/OFF、現在地を記録する）はサーバーに送りません。",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "インフラはCloudflareです（Workers、D1、R2、Workers AI、AI Gateway）。パスワード再設定の案内メールはResendへ委託します。データは日本国外のサーバで処理されることがあります。",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "法令に基づく場合を除き、個人情報を第三者に販売・提供しません。Cloudflare、Resend（パスワード再設定メール）、および（酒記録の推定時）その先のモデル提供者は、サービス提供のための委託先です。",
        },
      ],
    },
    {
