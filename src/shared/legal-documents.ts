  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "日本国内における酒類の年齢制限に合わせ、満20歳未満の方は利用できません。本規約への同意は、利用者が20歳以上であることの表明を含みます。",
        },
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "取得する情報は、アカウント（メール、パスワードのハッシュ、任意の表示名）、セッション、規約への同意、飲酒記録、マイドリンク、セラー、ノート、加工後の写真、AI利用回数、任意の位置情報（店名と座標）、バックアップ、運用ログです。端末だけの設定（外観、触感、動き、写真の既定、認識のON/OFF、現在地を記録する）はサーバーに送りません。",
        },
        {
          type: "p",
          text: "目的は、認証と設定表示、記録の保存と集計、写真の本人への配信、ラベル等の候補入力、不正防止、障害対応、バックアップ、同意の記録に限ります。販売、広告配信、他ユーザーへの公開には使いません。",
        },
      ],
    },
    {
