  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "取得する情報は、アカウント（メール、パスワードのハッシュ、任意の表示名、Googleアカウントの識別子。プロフィール画像は保存しません）、セッション、規約への同意、年齢確認（生年月日は確認に成功したときだけ）、パスワード再設定の短命トークン、飲酒記録、マイドリンク、セラー、ノート、加工後の写真、AI利用回数、任意の位置情報（店名と座標）、バックアップ、運用ログです。端末だけの設定（外観、触感、動き、写真の既定、認識のON/OFF、現在地を記録する）はサーバーに送りません。",
        },
        {
          type: "p",
          text: "目的は、認証とパスワード再設定、設定表示、満20歳以上であることの確認、記録の保存と集計、写真の本人への配信、ラベル等の候補入力、不正防止、障害対応、バックアップ、同意の記録に限ります。販売、広告配信、他ユーザーへの公開には使いません。",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "インフラはCloudflareです（Workers、D1、R2、Workers AI、AI Gateway）。パスワード再設定の案内メールはResendへ委託します。Googleログインでは認証のためGoogleへリダイレクトします。データは日本国外のサーバで処理されることがあります。",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "法令に基づく場合を除き、個人情報を第三者に販売・提供しません。Cloudflare、Resend（パスワード再設定メール）、Google（ログイン）、および（酒記録の推定時）その先のモデル提供者は、サービス提供のための委託先です。",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "アカウントがある間、サービス提供に必要なデータを保管します。パスワード再設定トークンは約1時間で失効します。未紐付け写真は作成から24時間で削除します。データベースのバックアップは約14日です。アカウント削除の画面は未実装です。削除を希望する場合は、本ポリシー掲載の連絡先（承認後）へ請求してください。請求が確認できたときは、法令とバックアップの保持期間の範囲で削除します。",
        },
      ],
    },
    {
